...
def draw_door():
    """Dibuja una puerta en la cara frontal de la casa"""
    glBegin(GL_QUADS)
    glColor3f(0.4, 0.2, 0.0)  # Marrón oscuro para la puerta

    # Coordenadas de la puerta (centrada en la cara frontal)
    glVertex3f(-0.3, 0, 1.001)
    glVertex3f(0.3, 0, 1.001)
    glVertex3f(0.3, 0.6, 1.001)
    glVertex3f(-0.3, 0.6, 1.001)
    glEnd()

def draw_windows():
    """Dibuja dos ventanas en la cara frontal de la casa"""
    glBegin(GL_QUADS)
    glColor3f(0.2, 0.5, 0.8)  # Azul para los cristales
